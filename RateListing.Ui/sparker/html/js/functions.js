(function ($) {
	...
	var $menu = $("nav#menu").mmenu({
		...
		navbars: [{position:'bottom',content: ['<a href="#0">© 2020 RateListing</a>']}]}, 
		{
		// configuration
		clone: true,
		classNames: {
	...
	// Range slider
	$("#distance_input").rangeslider({
		polyfill: false,
		onInit: function () {
			this.output = $("#distance_span").html(this.$element.val());
		},
		onSlide: function (
			position, value) {
    ...
    $("#rating_input").rangeslider({
        polyfill: false,
        onInit: function () {
            this.output = $("#rating_span").html(this.$element.val());
        },
        onSlide: function (
            position, value) {
            this.output.html(value);
    ...
    $("#customerRating_input").rangeslider({
        polyfill: false,
        onInit: function () {
            this.output = $("#customerRating_span").html(this.$element.val());
        },
        onSlide: function (
            position, value) {
            this.output.html(value);
